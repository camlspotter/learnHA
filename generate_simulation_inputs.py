...
def get_options() -> Options:
    ...
    parser.add_argument(
        '--seed', '-s', help='Random seed', type=int, default=None, required=False
    )
    parser.add_argument(
        '--num-inputs',
        '-n',
        help='Number of inputs to be generated',
        type=int,
        required=True,
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=simulation_options.parse_number_of_cps,
        required=True,
    )
    parser.add_argument(
        '--signal-types', help='Variable types', type=parse_signal_types, required=True
    )
    parser.add_argument(
        '--output-file',
        '-o',
