...
eval "pipenv run python simulate.py $VARIABLE_OPTS $SIMULATION_OPTS --simulink-model-file data/models/ex_sldemo_bounce_Input.slx -o _out/bball.txt -n 4"
...
eval "pipenv run python simulate.py $VARIABLE_OPTS $SIMULATION_OPTS --simulink-model-file data/models/ex_sldemo_bounce_Input.slx -o _out/bball0.txt -S 0 -n 4"


eval "pipenv run python simulate.py $VARIABLE_OPTS $SIMULATION_OPTS --simulink-model-file _out/learned_HA.slx -o _out/learned0.txt -S 0 -n 4"
