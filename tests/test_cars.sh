...
pipenv run python loop.py \
     \
     --input-variables 'Throttle,Brake' --output-variables 'y1,y2,y3,y4,y5' \
     \
     --simulink-model-file $MODEL \
     --time-horizon 80.0 --sampling-time 0.1 \
     --fixed-interval-data False \
     --invariant 'Throttle:(0,1), Brake:(0,1), y1:(0,0), y2:(10,10), y3:(20,20), y4:(30,30), y5:(40,40)' \
