...
from hybridlearner.simulation.input import Simulation_input, input_of_trajectory
...
def get_options() -> Options:
    ...
    parser.add_argument('--stl-spec', help='STL spec formula', type=str, required=True)
