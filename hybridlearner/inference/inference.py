...
def infer_model(
    ...
    print('filter_last_segment:', opts.filter_last_segment)
    print('segmentedTrajectoreis:', len(segmentedTrajectories))
    print('traj_spans:', len(traj_spans))

    # Jun: this is not true.
