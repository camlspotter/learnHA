...
def add_argument_group(parser : argparse.ArgumentParser) -> None:
    ...
    parser.add_argument('--number-of-cps', help='Number of control points', type=parse_number_of_cps, required=True)
    parser.add_argument('--signal-types', help='Variable signal types', type=parse_signal_types, required=True)
