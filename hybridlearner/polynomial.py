...
def build_polynomial(variables : list[str], degree : int, coeffs : list[float]) -> Polynomial:
...
def build_variable_annotated(variables : list[str], degree : int, coeffs : list[float]) -> VariableAnnotated:
